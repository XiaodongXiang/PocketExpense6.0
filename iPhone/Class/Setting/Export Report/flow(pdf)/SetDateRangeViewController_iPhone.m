...
#ifdef LITE
//    AppDelegate_iPhone *delegate_iPhone = (AppDelegate_iPhone *)[[UIApplication sharedApplication] delegate];
//    delegate_iPhone.btnAd.hidden = YES;
//    if (delegate_iPhone.bannerView_) {
//        delegate_iPhone.bannerView_.hidden = YES;
//    }
//    if (delegate_iPhone.adView) {
//        delegate_iPhone.adView.hidden = YES;
//    }
#endif
}
